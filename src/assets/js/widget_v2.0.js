...
!function (t) {
  ...
  !function () {
    ...
    var e = t.target, i = n(e);
    if (e && i) {
      var a = e.getBoundingClientRect(), s = i.getBoundingClientRect(),
        r = Math.max(a.left + a.width / 2 - s.width - 164, 0), o = a.top + a.height + 10;
